//
//  MobiBUADFullscreenCustomEvent.m
//  MobiAdSDK
//
...
@implementation MobiBUADFullscreenCustomEvent
...
- (void)requestFullscreenVideoWithCustomEventInfo:(NSDictionary *)info adMarkup:(NSString *)adMarkup {
    ...
    self.fullscreenVideoAd = [[BUNativeExpressFullscreenVideoAd alloc] initWithSlotID:adUnitId];
...
- (void)nativeExpressFullscreenVideoAdViewRenderFail:(BUNativeExpressFullscreenVideoAd *)rewardedVideoAd error:(NSError *_Nullable)error {
    self.rootVC = nil;
    if (self.delegate && [self.delegate respondsToSelector:@selector(fullscreenVideoAdViewRenderFailForCustomEvent:error:)]) {
        [self.delegate fullscreenVideoAdViewRenderFailForCustomEvent:self error:error];
    }
}
...
- (void)nativeExpressFullscreenVideoAdDidVisible:(BUNativeExpressFullscreenVideoAd *)fullscreenVideoAd {
    if (self.delegate && [self.delegate respondsToSelector:@selector(fullscreenVideoDidAppearForCustomEvent:)]) {
        [self.delegate fullscreenVideoDidAppearForCustomEvent:self];
    }
}
