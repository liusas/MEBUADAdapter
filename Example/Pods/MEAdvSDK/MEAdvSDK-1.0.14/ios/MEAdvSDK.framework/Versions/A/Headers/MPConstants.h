...
#define MINIMUM_REFRESH_INTERVAL            3.0
#define DEFAULT_BANNER_REFRESH_INTERVAL     5       // seconds
#define BANNER_TIMEOUT_INTERVAL             5       // seconds
#define INTERSTITIAL_TIMEOUT_INTERVAL       5       // seconds
#define REWARDED_VIDEO_TIMEOUT_INTERVAL     5       // seconds
#define NATIVE_TIMEOUT_INTERVAL             5       // seconds
#define SPLASH_TIMEOUT_INTERVAL             3       // seconds
