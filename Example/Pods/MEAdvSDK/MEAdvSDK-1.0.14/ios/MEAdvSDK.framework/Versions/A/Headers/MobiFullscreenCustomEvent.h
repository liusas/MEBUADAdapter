...
@protocol MobiFullscreenVideoCustomEventDelegate;

@protocol MobiFullscreenVideoCustomEvent <NSObject>
...
@property (nonatomic, weak) id<MobiFullscreenVideoCustomEventDelegate> delegate;
/// 当SDK请求拉取广告时,会调用此方法
/// 基类MobiFullscreenVideoCustomEvent实现了MobiFullscreenVideoCustomEvent接口
...
@interface MobiFullscreenCustomEvent : NSObject<MobiFullscreenVideoCustomEvent>
...
@protocol MobiFullscreenVideoCustomEventDelegate <NSObject>
