...
#pragma mark - 新增方法
/**
 * Sent when an ad will visible
 */
- (void)adViewWillVisible:(MPAdView *)view;

/**
 * This method is called when ad is clicked.
 */
- (void)adViewDidClick:(MPAdView *)view;

/**
 * This method called when ad is closed by user
 */
- (void)adViewWillClose:(MPAdView *)view;
