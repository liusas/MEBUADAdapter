 ...
 * 激励视频渲染失败,回调此方法
 */
- (void)rewardedVideoAdViewRenderFail:(MobiRewardedVideo *)rewardedVideo error:(NSError *_Nullable)error;
 ...
 */
- (void)rewardedVideoAdDidPlayFinish:(MobiRewardedVideo *)rewardedVideo didFailWithError:(NSError *)error;
