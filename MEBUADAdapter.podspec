...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MEBUADAdapter.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/刘峰/MEBUADAdapter'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '刘峰' => 'liufeng@mobiexchanger.com' }
  s.source           = { :git => 'https://github.com/刘峰/MEBUADAdapter.git', :tag => s.version.to_s }
